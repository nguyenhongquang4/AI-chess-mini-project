...
def evaluate_king_endgame_activity(board):
    ...
    if phase < 0.3:
        ...
        if white_king is not None:
            ...
            score += (7 - white_center_distance) * 20
...
#         material_diff = evaluate_material(board)
...
#                 attack_score += material_value.get(piece_on_sq.piece_type, 0) // 5
#
#     return attack_score
#
#
